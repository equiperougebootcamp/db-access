...
import com.bootcamp.annotations.NativeQueryResultColumn;
...
public class NativeQueryResultsMapper {
    ...
    private static Logger logger = LogManager.getLogger(com.bootcamp.utils.NativeQueryResultsMapper.class);
